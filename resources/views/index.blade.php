...
<html lang="en">
	...
	<body class="no-skin">
		<div id="navbar" class="navbar navbar-default" style="background:#0000ff"> <!--style navbar-->
			<div class="navbar-container" id="navbar-container">
				<div class="navbar-buttons navbar-header pull-right" role="navigation"> <!--navbar-->
					<ul class="nav ace-nav">
						<li class="light-green">
							<a href="{{url('/datas')}}"class="dropdown-menu-right dropdown-navbar">
								<span>
									DATA
						...
						<li class="light-green">
							<a href="{{url('/mutasi')}}" class="dropdown-menu-right dropdown-navbar">
								<span>
									MUTASI
